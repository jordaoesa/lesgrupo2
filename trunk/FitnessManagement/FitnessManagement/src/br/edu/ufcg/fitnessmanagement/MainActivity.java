...
import br.edu.ufcg.gerenciar.Ficha;
...
public class MainActivity extends Activity {
	...
	//TODO falta saber como vai ficar
	private void menuCadastrarAtividade() {
		setContentView(R.layout.cadastro_atividade);
		
		
		
		//clicou em adicionar exercicio
		Button botaoAdicionarExercicio=(Button) findViewById(R.id.botaoAdicionarExercicio);
		botaoAdicionarExercicio.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// cria o spinner
				Spinner spinnerDeExercicios = (Spinner)findViewById(R.id.spinnerDeExercicios);
				//pega o exercicio do spinner
				Exercicio exercicio = (Exercicio) spinnerDeExercicios.getSelectedItem();
				//agora tenta impimir na tela scrool o exercicio
				ListView listView = (ListView) findViewById(R.id.listViewExerciciosScroll);
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.item_list, R.id.textViewItem, alunos);
		...
		Button cadastrarAtividade = (Button) findViewById(R.id.botaoCadastrarAtividade);
		cadastrarAtividade.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				
				//peguei nome da ficha e da atividade
				String nomeAtividade = ((EditText) findViewById(R.id.caixaNomeAtividade)).getText().toString();
				String nomeFicha = ((EditText) findViewById(R.id.caixaNomeFicha)).getText().toString();
				
				
				
				
				//criei ficha e atividade
				Atividade atividade = new Atividade(nomeAtividade);
				Ficha ficha = new Ficha(nomeFicha);
				//add a atividadde na ficha
